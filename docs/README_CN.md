...
[**MLSLabsRenderer-Lite**](https://mls4dlive.cn/) 是由[**马栏山音视频实验室**](https://www.mlslabs.com.cn/).开发的一款高性能虚幻引擎 5 (UE5) 插件。它专为 3D 高斯泼溅 (3DGS) 和动态体积视频 (4DGS) 的实时可视化、管理及可扩展混合渲染而设计。
