...
<p align="center">
  <a href="https://github.com/mlslabs/MLSLabsGaussianSplattingRenderer-UE/blob/ue5.7-plugin-lite/LICENSE">
...
[**教学文档**](https://github.com/mlslabs/MLSLabsGaussianSplattingRenderer-UE/blob/ue5.7-plugin-lite/docs/README_CN.md) •
[**入门指南**](#入门指南) •
[**安装**](#installation) •
...
[**项目结构**](#项目结构) •
[**路线图**](#路线图-专业版) •
[**专业版**](https://github.com/mlslabs/MLSLabsGaussianSplattingRenderer-UE/tree/ue5.7-plugin-pro) •
[**版本记录**](#版本记录)
...
2. **关于项目打包：** 为确保项目顺利打包，请将 `MLSLabsRenderer` 文件夹复制到 UE5.7 引擎安装目录中（例如：`Epic Games\UE_5.7\Engine\Plugins\Marketplace`）。
