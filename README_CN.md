...
<p align="center">
  <a href="https://github.com/mlslabs/MLSLabsGaussianSplattingRenderer-UE/blob/Lite_1.0_ue5.6/LICENSE">
...
[**教学文档**](https://github.com/mlslabs/MLSLabsGaussianSplattingRenderer-UE/blob/Lite_1.0_ue5.6/docs/README_CN.md) •
[**入门指南**](#入门指南) •
[**安装**](#installation) •
...
[**项目结构**](#项目结构) •
[**路线图**](#路线图-专业版) •
[**专业版**](https://github.com/mlslabs/MLSLabsGaussianSplattingRenderer-UE/tree/Pro_1.0_ue5.6) •
[**版本记录**](#版本记录)
...
4. 兼容性维护： 完善针对 Unreal Engine 5.6 的打包脚本，确保 .ply 与 .sog 资产能正确被包含在 Release 包中。
